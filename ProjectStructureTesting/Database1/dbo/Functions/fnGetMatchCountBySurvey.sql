...
-- =============================================
CREATE FUNCTION [dbo].[fnGetMatchCountBySurvey]
(	
...
*/
	...
	*/
	...
	where t.SurveyNumber = @surveyNumber and (t.TargetMark = 2 or t.TargetMark = 3)
	group by t.Number
...
--	inner join v_DepartmentGroup g on g.DepartmentId = isNull(t.DepartmentId,g.DepartmentId) and g.GroupYear = isNull(t.[GroupYear], g.GroupYear)
	...
	where t.SurveyNumber = @surveyNumber and(t.TargetMark = 1 or t.TargetMark = 4) and gm.MemberId is not null and gm.[Enabled] = 1
	group by  t.Number

...
-- =============================================
CREATE PROCEDURE [dbo].[sp_QuestionUnit_GetListByPermission]
...
BEGIN
	...
	inner join [ViewPermission] vp on vp.PublishNumber = ps.Number and vp.QuestionNumber = q.QuestionNumber and vp.SubsetNumber = q.SubsetNumber and vp.GroupingNumber = q.GroupingNumber
...
END
--sp_QuestionUnit_GetListByPermission 89

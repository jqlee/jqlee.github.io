...
-- =============================================
CREATE PROCEDURE sp_StatQuestion_GetGroupingList
...
BEGIN
	...
	inner join QuestionScore qs on qs.ConfigNumber = rsi.ConfigNumber and qs.QuestionNumber = q.Number
